/**
 * Created by kyn on 17/10/10.
 */
/**
 * changed by kyn on 17/12/8
 * 为了修改掉节点出现的bug
 * 将时间控件创建节点 改到id为 app下的main-warp里
 * (原来在body下) 组件切换的时候时间控件还存在未被销毁
 * 例如 72行 73行
 */
  ...
  MobileCalendar.prototype = {
    ...
    bindEvent: function(type) {
      ...
      function popupDate(e) {
        ...
        document.querySelector(".main-warp").appendChild(_self.gearDate);
        dateCtrlInit();
      ...
      function dateCtrlInit() {
        ...
        if (_self.gearDate.querySelector(".date_dd")){
      ...
      function closeMobileCalendar(e) {
        ...
        document.querySelector(".main-warp").removeChild(_self.gearDate);
      }
      //日期确认
